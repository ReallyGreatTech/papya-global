...
class Services:
	...
	async def send_email(self, email, msg=None, url=None, name="User"):
		...
		# Determine which template to use and set the content accordingly
		if msg:
			...
			email_content = email_success_template.format(
				customer_name=name,
				video_link=url,
				unsubscribe_link="https://example.com/unsubscribe",
				privacy_policy_link="https://example.com/privacy-policy"
			...
			# Default content if neither msg nor url is provided
			email_content = email_success_template.format(
				customer_name=name,
				video_link="#",
				unsubscribe_link="https://example.com/unsubscribe",
		...
		message = MessageSchema(
			subject="Your customized Papya Global Advert",
